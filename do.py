...
st.set_page_config(
   ...
   menu_items={
       "Report a bug": "https://github.com/Nnerrr/HexapawnGame.git",
        "Get Help": "https://github.com/LamTrungHieu",
        "About": "Welcome to Hexapawn game!\n\nHave any comment? Please let me know through [this post](https://github.com/Nnerrr/HexapawnGame.git) or [issues](https://github.com/LamTrungHieu)!",
    },
   
)

#Đổi màu background ngoài
page_bg_img = f"""
<style>
...
def draw_info() -> None:
        # Text information
        TITLE.subheader("**🌃 Hexapawn Game in Streamlit**")
        ...
        GAME_INFO.markdown(
            ...
            ##### by <a href="https://github.com/Nnerrr/HexapawnGame.git" style="color:#FFFFFF">TeddyHuang-00</a> • <a href="https://github.com/Nnerrr/HexapawnGame.git" style="color:#FFFFFF">Github repo</a>
        ...
        SCORE_PLATE[0].metric("You", session_state.ROUND.SCORE[0])
        SCORE_PLATE[1].metric("Competitor", session_state.ROUND.SCORE[1])
        ...
        if session_state.ROUND.WINNER != _BLANK:
            ROUND_INFO.write(
                ...
                if _PLAYER_SYMBOL == _BLACK:
                    ROUND_INFO.write(
                        f"#### **{_PLAYER_SYMBOL[session_state.ROUND.PLAYER]} {_PLAYER_COLOR[session_state.ROUND.PLAYER]} 's turn...**"
                    )
                else:
                    ROUND_INFO.write(
                         f"#### **{_PLAYER_SYMBOL[session_state.ROUND.PLAYER]} {_PLAYER_COLOR[session_state.ROUND.PLAYER]}r turn...**"
